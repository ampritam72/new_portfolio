import { Project, Skill, Tool, WorkExperience, Education, Publication, LinkedInPost } from "./types";
...
export const initialLinkedInPosts: LinkedInPost[] = [
  {
    id: "li-1",
    author: "Abir Mahmud Pritam",
    headline: "B.Sc Student in Computer Science & Engineering | Full-Stack Developer | UI/UX Designer",
    date: "1 week ago",
    text: "Thrilled to share that I volunteered at UCICS-2025 (International Conference on Ubiquitous Computing and Intelligent Communication Systems), hosted by the Department of Computer Science & Engineering, Varendra University! 🎓✨\n\nServing as the Graphic Lead and Event Volunteer was an outstanding experience. Fusing creative visual designs with engineering research is where my passion lies. It was incredible to connect with esteemed professors, medical AI researchers, and peers, and discuss the latest trends in digital signal processing and deep learning. Fostering future computing breakthroughs right here in Rajshahi!",
    hashtags: ["UCICS2025", "VarendraUniversity", "ComputerScience", "AIResearch", "GraphicDesign", "Networking"],
    imageType: "ucics",
    likes: 184,
    reposts: 14,
    comments: [
      {
        ...
        headline: "Lecturer in CSE at Varendra University",
        text: "Outstanding work coordinating the conference graphics, Abir! You've set a high standard for academic chapter design.",
        date: "5 days ago",
        likes: 12
      },
      {
        ...
        headline: "CSE Sophomore | VU",
        text: "Awesome experience volunteering alongside you, Pritam. The banners looked amazing!",
        date: "6 days ago",
        likes: 5
      }
    ]
  },
  {
    ...
    headline: "B.Sc Student in Computer Science & Engineering | Full-Stack Developer | UI/UX Designer",
    date: "2 weeks ago",
    text: "Bridging the gap between Figma design sheets and functional frontend code! 💻🎨\n\nAs a creator, I always believe high-fidelity visual alignment is just as critical as algorithmic speed. For my latest project, Academic X (a student-focused productivity hub), I designed the entire wireframe layout in Figma, before building it in React, Vite, and Tailwind CSS. Fusing interactive grid metrics and rich glassmorphic elements is highly satisfying. The code is modular, fluid, and fully responsive!",
    hashtags: ["WebDevelopment", "UIUXDesign", "FigmaToCode", "ReactJS", "TailwindCSS", "CreativeCoding"],
    imageType: "academic",
    likes: 156,
    reposts: 9,
    comments: [
      {
        id: "lic-2-1",
        author: "Mehedi Hasan",
        headline: "Senior Software Engineer | Brain Station 23",
        text: "This is a clean transition, Abir! It's rare to see a developer with such a strong eye for typography and spacing.",
        date: "1 week ago",
        likes: 18
      }
    ]
  },
  {
    ...
    headline: "B.Sc Student in Computer Science & Engineering | Full-Stack Developer | UI/UX Designer",
    date: "1 month ago",
    text: "Deep Learning in Healthcare 🏥🧠\n\nI am excited to share my research and progress on hybrid computer vision models. I designed and evaluated a state-of-the-art Hybrid CNN-Vision Transformer (CNN-ViT) architecture aimed at automated Brain Tumor MRI classification.\n\nWhile traditional CNNs excel at capturing localized spatial details (edges, tissue borders), Vision Transformers capture long-range global context. Combining these two structures empowers models to deliver exceptionally robust healthcare diagnostics. Feel free to explore my open-source code and Kaggle notebooks linked on my portfolio!",
    hashtags: ["DeepLearning", "ComputerVision", "VisionTransformers", "MedicalImaging", "Kaggle", "ExplainableAI"],
    imageType: "deeplearning",
    likes: 212,
    reposts: 26,
    comments: [
      {
        id: "lic-3-1",
        author: "Dr. Tasnim Rahman",
        headline: "Associate Professor, Department of CSE",
        text: "Excellent study of medical diagnostic parameters. Fusing localized CNN bounds with Transformer vectors yields great accuracy results.",
        date: "3 weeks ago",
        likes: 34
      }
    ]
  },
  {
    ...
    headline: "B.Sc Student in Computer Science & Engineering | Full-Stack Developer | UI/UX Designer",
    date: "2 months ago",
    text: "RoboSoccer 2024 & Tech Carnival! 🤖⚽\n\nWhat an electrifying week organizing and volunteering at Varendra University's flagship tech event. Watching custom hardware bots compete, troubleshooting sensor relays in the pit, and supporting the team was an absolute blast. Kudos to the Dept of CSE for bringing such intense engineering passion to life!",
    hashtags: ["RoboSoccer2024", "TechCarnival", "VarendraUniversity", "Robotics", "EmbeddedSystems", "VolunteerLife"],
    imageType: "robosoccer",
    likes: 138,
    reposts: 6,
    comments: []
  }
